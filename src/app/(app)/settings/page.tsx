...
export default async function SettingsPage() {
  ...
  const {data:flat}=await s.from('flats').select('id,name,invite_code,meal_policy,allow_partial_settlement_payments,allow_settlement_overpayments').eq('id',m.flat_id).maybeSingle(); if(!flat)return <div className="card">Flat not found.</div>
