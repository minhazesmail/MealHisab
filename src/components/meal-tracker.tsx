      ...
      <div className="card sm:col-span-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            onClick={() => setMeal('extra', current('extra') - 1)}
          >
            −
          </button>
          ...
          <button
            ...
            disabled={pending || current('extra') >= 100}
            onClick={() => setMeal('extra', current('extra') + 1)}
          >
            +
          </button>
